...
- **It shrugs off everyday handling.** JPEG (quality 50 and 90), half-size downscale, and blur: 97 to 99% each. It does *not* survive a hard crop, the carriers are position-locked; we disclose that rather than hide it.
